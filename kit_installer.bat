...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/mind-ar-js/releases/download/v1.0.0/mind-ar-js-main.zip
SET REPO_NAME=mind-ar-js-main.zip
SET EXTRACTED_REPO_DIR=mind-ar-js-main
SET NOTEBOOK_NAME=Facefilters.html
Call:Download_repo
